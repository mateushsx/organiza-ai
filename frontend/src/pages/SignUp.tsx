...
export const SignUp = () => {
  return (
    <div className="mx-auto flex">
      <div
        className=" bg-cyan-600 h-[100vh] w-[50vw]
...
=======
        ...
        <button
          className=" text-cyan-500 uppercase border border-white
         bg-white w-60 rounded-3xl px-3 py-2 font-semibold text-lg hover:opacity-90 transition-all duration-300"
        >
          <Link to={'/signin'}> Entrar</Link>
>>>>>>> de7432b8e6e649f8a0f56a6be271cf49451cf9f3
        </button>
        </Link>
      </div>
      ...
      <div className="h-[100vh] w-[50vw] items-center justify-center flex flex-col gap-10">
        ...
        <form>
          <label className="flex flex-col mb-6">
            <span className="text-gray-400 font-semibold text-lg mb-2">Nome</span>
            <input
              type="text"
